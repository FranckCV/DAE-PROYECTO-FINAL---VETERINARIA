...
import capaNegocio.clsTipoExamen;
 ...
 */
public class jdMntTipoExamen extends javax.swing.JDialog {

    clsTipoExamen objTipo = new clsTipoExamen();

    /**
     * Creates new form jdMntTipoExamen
     */
    public jdMntTipoExamen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        listar();
    }
    ...
    private void initComponents() {
        ...
        tblTipoExamen = new javax.swing.JTable();
        ...
        setSize(new java.awt.Dimension(428, 618));
        ...
        tblTipoExamen.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblTipoExamenMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblTipoExamen);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            if (txtId.getText().equals("")) {
                ...
                rs = objTipo.buscar(Integer.parseInt(txtId.getText()));
                if (rs.next()) {
    ...
    private void tblTipoExamenMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTipoExamenMouseClicked
        // TODO add your handling code here:
        txtId.setText(String.valueOf(tblTipoExamen.getValueAt(tblTipoExamen.getSelectedRow(), 0)));
        //El cero de la derecha me dice en qué columna me estoy centrando.
        btnBuscarActionPerformed(null);
    }//GEN-LAST:event_tblTipoExamenMouseClicked
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try {
            if (btnRegistrar.getText().equals("Registrar")) {
                ...
                limpiarControles();
                txtId.setText(objTipo.generarCodigo().toString());
                txtNombre.requestFocus();
            } else {
                btnRegistrar.setText("Registrar");
                objTipo.registrar(Integer.parseInt(txtId.getText()), txtNombre.getText());
                limpiarControles();
                listar();
            }
        } catch (Exception e) {
...
//                    JOptionPane.showMessageDialog(this, "Se modificó");
        ...
        try {
            if (txtId.getText().equals("")) {
                ...
                int result = JOptionPane.showConfirmDialog(this, "¿Estás seguro de que quieres eliminar el tipo de examen"
                        ...
                        "Confirmacion", JOptionPane.YES_NO_OPTION);
                if (result == JOptionPane.YES_OPTION) {
                    objTipo.eliminar(Integer.valueOf(txtId.getText()));
                    limpiarControles();
                    listar();
                } else {
    ...
    private void listar() {
        ...
        try {
            rsTipoExamen = objTipo.listarTipoExamen();
    ...
    private javax.swing.JTable tblTipoExamen;
