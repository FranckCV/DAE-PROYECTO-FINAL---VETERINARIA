 ...
 * @author Junior
 */
public class jdRepIngresosMensuales extends javax.swing.JDialog {

    /**
     * Creates new form jdRepIngresosMensuales
     */
    public jdRepIngresosMensuales(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//            objReporte.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdRepIngresosMensuales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdRepIngresosMensuales dialog = new jdRepIngresosMensuales(new javax.swing.JFrame(), true);
